...
def main():
    ...
    loader = DataLoader(extractor.spark)
    ...
    loader.save_to_csv(df_demographie_transformed, demo_csv)
        ...
        # Définition des chemins vers les fichiers consolidés (ils se trouvent dans "data/processed_data")
    ...
    # Appel à la méthode de génération du fichier consolidé à partir des CSV
